...
Par un jeu de récompense et de punition, on apprend aux machines à trouver le schéma permettant de gagner à tous les coups si on joue en deuxième. 
(Toujours prendre le complément à 4 du choix du premier: 21=4*5+1. Le joueur 1 tombera forcément sur le dernier batonnet)"""
